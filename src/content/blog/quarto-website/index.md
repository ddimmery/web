...
To demonstrate how I've set things up to populate the website from data about my academic life, I'll focus on my [publications](/research/) page. There are two main files undergirding this page:
...
<details><summary>See <code>research.qmd</code> fragment</summary>
...
I use the same basic setup to populate the [Software page](/software/), albeit with simpler logic.
...
I imagine my CV is similar to most academics' in that it's built like a house of cards (and overfull hboxs). Whenever I add something new to it, I have to copy some lines from elsewhere and modify them to fit the new entry. This always takes me way more time than I'd like. If I mashed together my current [About page](/about/) with the [Research page](/research/), it's like 90% of the way to a full CV. It should presumably be pretty easy to do explicitly combine them and output a reasonable-looking CV.
...
An almost completely naïve approach to directly importing the relevant pages creates [this ugly document](/posts/quarto-website/cv.pdf).
