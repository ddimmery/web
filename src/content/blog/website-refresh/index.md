...
![Workflow Dispatch example](./workflow-dispatch.png)
...
Long story short, I've currently landed on the following font styling that I intend to use pretty generally across the web, in documents and on presentations[^fn2]:

[^fn2]: The ease of writing Markdown documents which are rendered into [reveal.js](https://revealjs.com/) HTML presentations is really nice, and yet another way that I'm aiming at convergence between these media. I ask myself whether I should also move away from directly writing LaTeX, too. Ensuring visual consistency by using literally identical styling directives is very appealing.

- Headers in [URW Classico](https://en.wikipedia.org/wiki/Optima#Clones_and_derivatives). This is a font based largely on [Optima](https://en.wikipedia.org/wiki/Optima).
